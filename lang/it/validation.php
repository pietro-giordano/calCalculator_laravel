...
return [
    ...
    */
      ...
      'custom' => [
            'name' => [
                  'required' => 'Inserire nome del prodotto',
            ],
            'brand' => [
                  'required' => 'Inserire marchio del prodotto',
            ],
            'image' => [
                  'required' => "E' possibile caricare solo file immagine supportati",
            ],
            'calories_hundred_grams' => [
                  'required' => 'Inserire calorie del prodotto',
            ],
            'carbs_hundred_grams' => [
                  'required' => 'Inserire carboidrati del prodotto',
            ],
            'fats_hundred_grams' => [
                  'required' => 'Inserire grassi del prodotto',
            ],
            'saturated_fats_hundred_grams' => [
                  'required' => 'Inserire grassi saturi del prodotto',
            ],
            'proteins_hundred_grams' => [
                  'required' => 'Inserire proteine del prodotto',
            ],
      ],
    ...
    */
      ...
      'attributes' => [
            ...
            'image' => 'immagine',
            'calories_hundred_grams' => 'calorie',
            'carbs_hundred_grams' => 'carboidrati',
            'sugars_hundred_grams' => 'zuccheri',
            'fats_hundred_grams' => 'grassi',
            'saturated_fats_hundred_grams' => 'grassi saturi',
            'proteins_hundred_grams' => 'proteine',
            'fibers_hundred_grams' => 'fibre',
      ],
